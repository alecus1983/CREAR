...
<!-- Fecha de nacimiento -->
<div id="d13" class="text_formulario">
<label class="parrafo ">Fecha de nacimiento</label></div>
<div id="d14"><input id="nacimiento" class="tag_formulario" type="date" required /></div>

<!-- Ciudad de nacimiento-->
<div> <label class="parrafo"> Ciudad de nacimiento</label></div>
...
<label class="parrafo">Correo</label></div>
...
<label class="parrafo">Teléfono</label></div>
...
<div id="d20" class="text_formulario"> <label>Tipo de indentificación</label> </div>
<div id="d21">
...
<label class="parrafo">Número de documento</label></div>
<div id="d23"><input id="cedula" class="tag_formulario" maxlength="12" type="text"
placeholder="número de documento" required /></div>

<!-- lugar de expedicion-->
<div id="d24"><label>Lugar de expedici&oacute;n</label></div>
<div id="d25"> <input id="lugar_exp_estudiante" type="text" class="tag_formulario"
placeholder="lugar de expedición" required></input></div>

<div id="d26"><label class="parrafo">G&eacute;nero: </label></div>
...
<!-- grupo rh -->
<div id="28" class="text_formulario"> <label class="parrafo"> Grupo RH</label> </div>
...
<!-- Sisben -->
<div id="30" class="text_formulario"> <label class="parrafo"> Sisben</label></div>
...
<div id="32" class="text_formulario"> <label class="parrafo"> Direcci&oacute;n de residencia:</label> </div>
<div id="33"> <input id="direccion_estudiante" type="text" class="tag_formulario" placeholder="direccion de residencia" required></div>

<!-- Barrio -->
<div id="34" class="text_formulario"> <label class="parrafo"> </label> Barrio: </div>
<div id="35"> <input id="barrio" name="barrio" type="text" placeholder="barrio" maxlength="40" required> </div>
...
<!-- Vive con-->
<div id="38" class="text_formulario"> <label class="parrafo"> Vive con : </label> </div>
...
<label class="parrafo">Nombres</label></div>
<div id="d41">
...
<label class="parrafo ">Apellidos</label></div>
<div id="d43">
...
<!-- tipo de indentificacion -->
<div id="d48" class="text_formulario"> <label>Tipo de indentificación</label> </div>
<div id="d49">
...
<label class="parrafo">Cédula</label></div>
<div id="d51"><input id="cedula_padre" class="tag_formulario" maxlength="12" type="text"
placeholder="número de documento" required /></div>

<!-- lugar de expedicion-->
<div id="52"><label>Lugar de expedici&oacute;n</label></div>
...
placeholder="direccion de residencia" required></div>

<!-- Barrio -->
<div id="56" class="text_formulario"> <label class="parrafo"> </label> Barrio: </div>
...
<!-- tipo de indentificacion -->
<div id="d68" class="text_formulario"> <label>Tipo de indentificación</label> </div>
<div id="d69">
...
<!-- lugar de expedicion-->
<div id="72"><label>Lugar de expedici&oacute;n</label></div>
<div id="73"> <input id="lugar_exp_madre" type="text" class="tag_formulario"
placeholder="lugar de expedición" required></input></div>


<!-- Direccion de residencia -->
<div id="74" class="text_formulario"> <label class="parrafo"> Direccion de residencia:</label> </div>
<div id="75"> <input id="direccion_madre" type="text" class="tag_formulario"
placeholder="direccion de residencia" required></div>

<!-- Barrio -->
<div id="76" class="text_formulario"> <label class="parrafo"> </label> Barrio: </div>
<div id="77" > <input id="barrio_madre" name="barrio_madre" type="text"
placeholder="barrio" maxlength="40" required> </div>
