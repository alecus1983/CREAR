...
<head>
  ...
  $(document).on('change', '#vivecon', function(event) {
    ...
    switch (padres) {
      ...
      $(".madre").validator("update");
      $(".padre").validator('destroy');
          ...
          <p >En el siguiente formulario usted podrá realizar el trámite de
            ...
            <div id="datos_estudiantes" >
              ...
              <div  class="form-group">
                ...
                class="form_estudiante form-control" type="date"  required/>
              </div>
              ...
              <div class="form-group">
                ...
                onchange='actualizar_grados_escolaridad();' >";
              ...
              <!-- telefono -->
              <div class="form-group">
                <label from="telefono" class="control-label">Teléfono</label>
              ...
              <!-- grupo rh -->
              <div class="form-group"> <label class="control-label"> Grupo RH</label>
              ...
              <!-- Estrato-->
              <div class="form-group">
                <label from_"estrato" class="control-label"> Estrato </label>
            ...
            <!-- Vive con-->
            <div class="form-group"> <label class="control-label"> Vive con : </label>
            </div>
            <div>
