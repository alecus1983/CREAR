...
<html  >
  ...
  <body onload="ocultar_todo();">
      ...
      if($entrega >= $hoy) {
	      ...
	      .$entrega." , restan ".$diferencia_dias." </font></b>";
      }
      ...
      <script type="text/javascript">
       ...
       // este es el que permite a los docentes ingresar las notas de los alumnos
	  ...
	  <div id=" encabezado" style="width: 100%" >
	      ...
	      <a href="../imagenes/tutorial.png" target="blank">tutorial </a><br>
	  ...
	  <div>
		  ...
		  <? if($admin) { ?>
		      <input type="number" value="<?php echo date('Y');?>" id="years" name="years"
			     min="2015" max="2100" step="1" required="required" style="width: 50px;background-color: transparent;border: none;" >
		  ...
		  <select id="jornada" placeholder="Seleccione la jornada" style=" background-color: transparent;border: none;">
		  ...
		  <select id='periodos' name="periodos" placeholder="seleccione el periodo" style="background-color: transparent;border: none;">
		      <?	if($admin) { ?>
		  ...
		  <select id="corte" style="width: 50px;background-color: transparent;border: none;" >
		  ...
		  <select id="id_g" name="id_gs" style="display: inline; background-color: transparent;border: none;">
		      <option value="-1">Seleccione
		      </option>
		  </select>
	  ...
	  <div id="consultar" class="menu_consultar" colspan="1">
		  ...
		  <fieldset id="estudiante_con" class="filas_formulario" style="display: none;">
		      ...
		      <select id="estudiantes_con" name="estudiantes" style="width: 50px;background-color: transparent;border: none;">
			  <option value="-1">Seleccione
			  </option>
		      </select>
		  </fieldset>
		  ...
		  <fieldset id="id_m_con" class="filas_formulario" style="display: none;">
		      Materia:
		      <select id="id_ms_con" name="id_ms" style="background-color: transparent;border: none;">
			  <option value="-1">Seleccione
			  </option>
		      </select>
		  </fieldset>
		  ...
		  <fieldset id="Logro_con" class="filas_formulario" style="display: block;">
		      Logro:
		      <textarea rows="4" cols="90" id="Logros_con" name="Logros" style="width: 80%;"></textarea>
		  </fieldset>
