...
select * delete from imcreati_datam.matricula  where id_alumno =1599
...
ALTER TABLE imcreati_datam.c_2026 MODIFY COLUMN l1_p1 INT UNSIGNED DEFAULT NULL NULL;
ALTER TABLE imcreati_datam.c_2026 MODIFY COLUMN l2_p1 INT UNSIGNED DEFAULT NULL NULL;
ALTER TABLE imcreati_datam.c_2026 MODIFY COLUMN l3_p1 INT UNSIGNED DEFAULT NULL NULL;

ALTER TABLE imcreati_datam.c_2026 MODIFY COLUMN l1_p2 INT UNSIGNED DEFAULT NULL NULL;
ALTER TABLE imcreati_datam.c_2026 MODIFY COLUMN l2_p2 INT UNSIGNED DEFAULT NULL NULL;
ALTER TABLE imcreati_datam.c_2026 MODIFY COLUMN l3_p2 INT UNSIGNED DEFAULT NULL NULL;

ALTER TABLE imcreati_datam.c_2026 MODIFY COLUMN l1_p3 INT UNSIGNED DEFAULT NULL NULL;
ALTER TABLE imcreati_datam.c_2026 MODIFY COLUMN l2_p3 INT UNSIGNED DEFAULT NULL NULL;
ALTER TABLE imcreati_datam.c_2026 MODIFY COLUMN l3_p3 INT UNSIGNED DEFAULT NULL NULL;

ALTER TABLE imcreati_datam.c_2026 MODIFY COLUMN l1_p4 INT UNSIGNED DEFAULT NULL NULL;
ALTER TABLE imcreati_datam.c_2026 MODIFY COLUMN l2_p4 INT UNSIGNED DEFAULT NULL NULL;
ALTER TABLE imcreati_datam.c_2026 MODIFY COLUMN l3_p4 INT UNSIGNED DEFAULT NULL NULL;


ALTER TABLE imcreati_datam.c_2026 MODIFY COLUMN R1 INT UNSIGNED DEFAULT NULL NULL;
ALTER TABLE imcreati_datam.c_2026 MODIFY COLUMN R2 INT UNSIGNED DEFAULT NULL NULL;
ALTER TABLE imcreati_datam.c_2026 MODIFY COLUMN R3 INT UNSIGNED DEFAULT NULL NULL;
ALTER TABLE imcreati_datam.c_2026 MODIFY COLUMN R4 INT UNSIGNED DEFAULT NULL NULL;
