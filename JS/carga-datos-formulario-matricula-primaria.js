...
// Funcion que envia los datos de la matricula
	function enviar_matricula() {
		...
		var grado = $("#grados_escolaridad").val();
		var ngrado = $("#grados_escolaridad option:selected").text();
		...
		var documento_estudiante = document.getElementById("documento_estudiante").value;
		...
		var documento_padre = document.getElementById("documento_padre").value;
		...
		var documento_madre = document.getElementById("documento_madre").value;
