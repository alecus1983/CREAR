							...
							<div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne"
								...
								<nav class="sb-sidenav-menu-nested nav">
									...
									<input type="number" value="<?php echo date('Y'); ?>" id="years" name="years"
										...
										style="background: transparent;color: darkgreen;border: 0px;" <?php if ($admin <
										1) { ?>
									readonly="readonly"
									<?php
}?>
									...
									<select id="periodos" style="background: transparent;color: darkgreen;border: 0px"
										name="periodos" class="form-control" required="" onchange="load_semanas();">
...
?>
							...
							<div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne"
								...
								<nav class="sb-sidenav-menu-nested nav">
									<a style="margin: 0.5rem;" class="nav-link" href="#" target="_self"
								...
								<nav class="sb-sidenav-menu-nested nav">
									<a style="margin: 0.5rem;" class="nav-link" href="#" target="_self"
										...
										<span style="margin :auto;"
											class="badge bg-secondary rounded-pill bg-danger">Nuevo</span>
									</a>
								</nav>
							...
							<div class="collapse" id="collapseLayouts3" aria-labelledby="headingOne"
								...
								<nav class="sb-sidenav-menu-nested nav">
									<a style="margin: 0.5rem;" class="nav-link" href="#" href="listado_docentes.php"
										target="_blank">lista de docentes
									</a>
									<a style="margin: 0.5rem;" class="nav-link" href="#"
										onclick="avance_semanal();">Avance notas semanales
									</a>

									<a style="margin: 0.5rem;" class="nav-link" onclick="boletin()">Boletin
										<span style="margin :auto;"
											class="badge bg-secondary rounded-pill bg-danger">Nuevo
											<br>preescolar</span>
									</a>

									<a style="margin: 0.5rem;" class="nav-link" onclick="crear_pdf()">Certificado
										<span style="margin :auto;"
											class="badge bg-secondary rounded-pill bg-danger">Nuevo</span>
									</a>

									<a style="margin: 0.5rem;" class="nav-link" onclick="cuadro();">Generar cuadro de
										notas
									</a>
