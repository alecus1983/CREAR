...
<head>
	...
	<script src="js/all.js"></script>
	<link href="../assets/img/fundacion_instituto_mundo_creativo_logo.svg" rel="shortcut icon" />
					...
					if (valido) {
						...
						$.ajax({
							...
							success: function(data) {
								...
								alert("Se ingresaron las notas con exito")
...
<body class="sb-nav-fixed">
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				...
				<div>
					<h5 style="font-size: 20px;" class="logo-text">Mundo <br> <strong>Creativo</strong></h5>
				</div>
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					<a href="javascript:;" class="has-arrow">
						<div class="parent-icon"><i class="fa-regular fa-square-check"></i>
						</div>
						<div class="menu-title">Datos</div>
					</a>
					<ul>
						<li><a><i class="bx bx-right-arrow-alt"></i>
								<label for="years">Año</label>
								<input type="number" value="<?php echo date('Y'); ?>" id="years" name="years" min="2015" max="2100" step="1" style="background: transparent;color: darkgreen;border: 0px;" <?php if ($admin !== 1) { ?> readonly="readonly" <?php } ?> class="form-control ">
						...
						<li> <a><i class="bx bx-right-arrow-alt"></i>
								...
								<select id="jornada" style="background: transparent;color: darkgreen;border: 0px" class="form-control" onchange="actualizar();">
						...
						<li> <a><i class="bx bx-right-arrow-alt"></i>
								...
								<select id="periodos" style="background: transparent;color: darkgreen;border: 0px" name="periodos" class="form-control" required="" onchange="load_();">
									<?php
									if ($admin) {
						...
						<li> <a><i class="bx bx-right-arrow-alt"></i>
								...
								<select id="semana" class="form-control" style="background: transparent;color: darkgreen;border: 0px" onchange="load_lista_estudiantes();">
									<?php
									if ($admin) {
										// opciones
										$s = new semana();
						...
						<li> <a><i class="bx bx-right-arrow-alt"></i>
								...
								<select id="id_g" name="id_gs" class="form-control" style="background: transparent;color: darkgreen;border:  0px" onchange="actualizar();">
									<?php
						...
						<li> <a><i class="bx bx-right-arrow-alt"></i>
								...
								<select id="id_c" style="background: transparent;color: darkgreen;border:0px;" onchange="load_lista_estudiantes();" class="form-control">
						...
						<li> <a><i class="bx bx-right-arrow-alt"></i>
								...
								<select id="id_ms" style="background: transparent;color: darkgreen;border: 0px" name="id_ms" onchange="load_lista_estudiantes();" class="form-control">
								</select>
							</a>
						</li>
					</ul>
				...
				<li>
					<a href="https://wa.link/5gai9l" target="N_BLACK">
					...
					<div class="user-box dropdown">
						...
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<div class="user-info ps-3">
								<p class="designattion mb-0">Registrado(a) como:</p>
								<p class="user-name mb-0"><i class="fas fa-user fa-fw"></i>
									<?php echo ucwords(strtolower($d->nombres)) . " " . ucwords(strtolower($d->apellidos)); ?> </p>
	...
	<footer class="page-footer">
		...
		<div style="margin: auto;" class="row col-12">
			<button type="button" class=" btn btn-outline-success" value="INGRESAR" id="ingresar" onclick="deposit();">
				Ingresar
			</button>
		</div>
