...
$html = $html . "<input  class='form-control' id='nombres' aria-describedby='nombres' onkeydown='cambio_datos();'>";
...
$html = $html . "<input  class='form-control' id='apellidos' aria-describedby='apellidos' onkeydown='cambio_datos();'>";
...
$html = $html . "<input  class='form-control' id='identificacion' aria-describedby='identificacion' type='number' onkeydown='cambio_datos();'>";
