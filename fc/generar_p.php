...
foreach($list->id_alumno  as $e){
    ...
    $pdf->Cell(80,5,utf8_decode($estudiante->nombres." ".$estudiante->apellidos),1,0,'C');
    $pdf->Cell(25,5,utf8_decode($nivel),1,0,'C');
    $pdf->Cell(25,5,"mañana",1,0,'C');
    ...
    // WHERE calificaciones.id_alumno=" .$e."
