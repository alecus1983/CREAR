...
<head>
    ...
    <!-- ======== Page title ============ -->
    <title>Fundación Instituto Mundo Creativo | Educación</title>
    <!-- ========== Favicon Icon ========== -->
    <link rel="shortcut icon" href="assets/img/fundacion_instituto_mundo_creativo_logo.svg">
    <!-- ===========  All Stylesheet ================= -->
    <!--  Icon css plugins -->
                    ...
                    <div class="col-md-5 col-12">
                        <div class="header-right-cta d-flex justify-content-end">
                            <div class="social-profile mr-30">
                                ...
                                <a target="_blank" href=" https://wa.link/5gai9l"><i
                                        class="fab fab fa-whatsapp"></i></a>
                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="header-right d-flex align-items-center">
                        <div class="header-btn-cta">
                            <a href="contact.html" class="theme-btn">Conoce más<i class="fas fa-arrow-right"></i></a>
                        </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-6">
                            <div class="hero-contents">
                                <br><br>
                                <h1>Técnicos <span style="color: #FFDE59;">Laborales 2023</span></h1>
                                <p style="font-family: 'Encode Sans Condensed', sans-serif;">Que esperas para unirte a
                                    nuestra familia Creativista, No dejes pasar esta es tu oportunidad. Invierte en tu
                                    futuro, y cumple tus sueños.</p>
                                <a href="services.html" class="theme-btn">Ver Programas<i
                                        class="fas fa-arrow-right"></i></a>
                                <!-- <a style="color: white;" href="about.html" class="theme-btn minimal-btn">Conoce más<i
                                        class="fas fa-arrow-right"></i></a> -->
                            </div>
                        ...
                        <div class="col-lg-6 mt-5 mt-lg-0 col-12 pl-lg-5">
                            <div class="hero-banner">
                                <div class="dot"></div>
                                <img class="rounded" src="assets/img/home4/hero-5.png"
                                    class="d-block mx-lg-auto img-fluid rounded shadow-lg"
                                    src="./recursos/img/colegio_instituto_mundo_creativo.jpg">
                            </div>
                        </div>
        ...
        <div class="d-flex-">
            <div class="col-lg-6  p-4">
                ...
                <p style="color: #4f4f4f;">En Mundo Creativo contamos con altos entandares de calidad educativa , ofrecemos una experiencia
                    formativa desarrollando estudiantes capaces de emprender un proyecto de vida transformador en una
            ...
            <!--Img-->
            <div class="col-6  p-4 img-div-col">
                <img src="./assets/img/Colegio/Colegio.jpg" class="d-block mx-lg-auto img-fluid rounded shadow-lg"
                    alt="...">
            </div>
        </div>
    </section>
        ...
        <div class="d-flex-2">
            <div class="col-lg-6  p-4">
                ...
                <p style="color: #4f4f4f;">Contamos con un plan de educación para el trabajo y el desarrollo humano, El estudiante creativista
                    se formara para contribuir a la formación integral y permanente de las personas y la sociedad en
                    general. Por eso cuenta con los Programas Técnico Laborales, que son flexibles y coherentes con las
                    necesidades y expectativas de los individuos y las tendencias actuales.</p>
                <br>
                <div class="header-btn-cta">
                    <a href="tecnicos.php" class="theme-btn">Conoce más<i class="fas fa-arrow-right"></i></a>
                </div>
            </div>

            <!--Img-->
            <div class="col-6  p-4 img-div-col">
                <img src="./assets/img/Colegio/tecnicos.jpg" class="d-block mx-lg-auto img-fluid rounded shadow-lg"
                    alt="...">
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 mb-4">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="mb-1">
                                <a href="https://wa.link/5gai9l" style="color: #4f4f4f;">Protocolos de Bioseguridad</a>
                            </li>
                            <li class="mb-1">
                                <a href="https://wa.link/5gai9l" style="color: #4f4f4f;">Nuestro Campus</a>
                            </li>
                            <li class="mb-1">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <h5 class="mb-3">Colegio</h5>
                        <ul class="list-unstyled mb-0">
                            <li class="mb-1">
                                <a href="https://wa.link/5gai9l" style="color: #4f4f4f;">Preescolar</a>
                            </li>
                            <li class="mb-1">
                                <a href="https://wa.link/5gai9l" style="color: #4f4f4f;">Primaria</a>
                            </li>
                            <li class="mb-1">
                                <a href="https://wa.link/5gai9l" style="color: #4f4f4f;">Bachillerato</a>
                            </li>
                            <li>
                                <a href="https://wa.link/5gai9l" style="color: #4f4f4f;">Ciclos</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-4">
                        <h5 class="mb-3">Tecnicos Laborales</h5>
                        <ul class="list-unstyled mb-0">
                            <li class="mb-1">
                                <a href="https://wa.link/5gai9l" style="color: #4f4f4f;">Sistemas</a>
                            </li>
                            <li class="mb-1">
                                <a href="https://wa.link/5gai9l" style="color: #4f4f4f;">Deporte</a>
                            </li>
                            <li class="mb-1">
                                <a href="https://wa.link/5gai9l" style="color: #4f4f4f;">Asistente admistrativo</a>
                            </li>
                            <li>
                                <a href="https://wa.link/5gai9l" style="color: #4f4f4f;">Curso de Inglés</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-4">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="mb-1">
                                <a href="https://wa.link/5gai9l" style="color: #4f4f4f;">Soporte Técnico</a>
                            </li>
                            <li class="mb-1">
                                <a href="https://wa.link/5gai9l" style="color: #4f4f4f;">Secretaría</a>
                            </li>
                        </ul>
                    </div>
                </div>
