...
<!--HOme-->
<section class="page-banner-wrap bg-cover baner-small" style="background-image: url(./assets/img/banertecnicos.svg);">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-12 col-12">
                <div class="page-heading text-white">
                    <div class="page-title">
                        <h1>T&eacute;cnicos Laborales</h1>
                    </div>
                </div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Inicio</a></li>
                        <li class="breadcrumb-item active" aria-current="page">T&eacute;cnicos Laborales</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<br><br>
<!-- REDES SOCIALES -->
<div style="margin-top: -50px;" class='flx'>
        ...
        <div class="row align-items-center">
            <div class="col-md-12 col-12">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Inicio</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Tecnicos Laborales</li>
                    </ol>
                </nav>
            </div>
        </div>
