				...
				<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion"
					...
					<div class="sb-sidenav-menu">
							...
							<div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
								...
								<nav class="sb-sidenav-menu-nested nav">
									...
									<input type="number" value="<?php echo date('Y'); ?>" id="years" name="years"
										...
										style="background: transparent;color: darkgreen;border: 0px;" <?php if ($admin !== 1) { ?> readonly="readonly" <?php } ?> class="form-control ">

									<input type="hidden" value="<?php echo $id; ?>" id="id_d">

									<label for="jornada">Jornada</label>
									<select id="jornada" style="background: transparent;color: darkgreen;border: 0px"
									...
									<select id="periodos" style="background: transparent;color: darkgreen;border: 0px"
										name="periodos" class="form-control" required="" onchange="load_();">
										<?php
					    ...
					    <option value="5">Recuperacion</option>';
									...
									<select id="id_c" style="background: transparent;color: darkgreen;border:0px;"
									...
									<select id="id_ms" style="background: transparent;color: darkgreen;border: 0px"
										name="id_ms" onchange="load_lista_estudiantes();" class="form-control">
									</select>
									...
									<div class="card border-primary border-5">
										...
										<div class="card-body container">
											<div class="row align-items-center">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label for="inicio1" class="form-label text-muted fst-italic">
															inicio semana 1</label>
														<label for="inicio1"
															class="form-label text-muted fst-italic">inicio semana
															1</label>
												...
												<div class="col-md-6">
													<div class="form-group ">
														<label for="fin1" class="form-label text-muted fst-italic">
															fin semana 1
														</label>
														<label for="fin1" class="form-label text-muted fst-italic">fin
															semana 1</label>
											...
											<div class="row align-items-center">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label for="inicio2" class="form-label text-muted fst-italic">
															inicio semana 2
														</label>
														<label for="inicio2"
															class="form-label text-muted fst-italic">inicio semana
												...
												<div class="col-md-6">
													<div class="form-group ">
														<label for="fin2" class="form-label text-muted fst-italic">
															fin semana 2
														</label>
														<label for="fin2" class="form-label text-muted fst-italic">fin
															semana 2</label>
											...
											<div class="row align-items-center">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label for="inicio3" class="form-label text-muted fst-italic">
															inicio semana 3
														</label>
														<label for="inicio3"
															class="form-label text-muted fst-italic">inicio semana
												...
												<div class="col-md-6">
													<div class="form-group ">
														<label for="fin3" class="form-label text-muted fst-italic">
															fin semana 3
														</label>
														<label for="fin3" class="form-label text-muted fst-italic">fin
															semana 3</label>
											...
											<div class="row align-items-center">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label for="inicio4" class="form-label text-muted fst-italic">
															inicio semana 4
														</label>
														<label for="inicio4"
															class="form-label text-muted fst-italic">inicio semana
												...
												<div class="col-md-6">
													<div class="form-group ">
														<label for="fin4" class="form-label text-muted fst-italic">
															fin semana 4
														</label>
														<label for="fin4" class="form-label text-muted fst-italic">fin
															semana 4</label>
											...
											<div class="row align-items-center">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label for="inicio5" class="form-label text-muted fst-italic">
															inicio semana 5
														</label>
														<label for="inicio5"
															class="form-label text-muted fst-italic">inicio semana
												...
												<div class="col-md-6">
													<div class="form-group ">
														<label for="fin5" class="form-label text-muted fst-italic">
															fin semana 5
														</label>
														<label for="fin5" class="form-label text-muted fst-italic">fin
															semana 5</label>
											...
											<div class="row align-items-center">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label for="inicio6" class="form-label text-muted fst-italic">
															inicio semana 6
														</label>
														<label for="inicio6"
															class="form-label text-muted fst-italic">inicio semana
												...
												<div class="col-md-6">
													<div class="form-group ">
														<label for="fin6" class="form-label text-muted fst-italic">
															fin semana 6
														</label>
														<label for="fin6" class="form-label text-muted fst-italic">fin
															semana 6</label>
											...
											<div class="row align-items-center">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label for="inicio7" class="form-label text-muted fst-italic">
															inicio semana 7
														</label>
														<label for="inicio7"
															class="form-label text-muted fst-italic">inicio semana
												...
												<div class="col-md-6">
													<div class="form-group ">
														<label for="fin7" class="form-label text-muted fst-italic">
															fin semana 7
														</label>
														<label for="fin7" class="form-label text-muted fst-italic">fin
															semana 7</label>
											...
											<div class="row align-items-center">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label for="inicio8" class="form-label text-muted fst-italic">
															inicio semana 8
														</label>
														<label for="inicio8"
															class="form-label text-muted fst-italic">inicio semana
										...
										<div class="card border-success">
											...
											<div class="card-body container">
												<div class="row align-items-center">
													...
													<div class="col-md-6">
														<div class="form-group ">
															<label for="fin9" class="form-label text-muted fst-italic">
																fin semana 9
															</label>
															<label for="fin9"
																class="form-label text-muted fst-italic">fin semana
																9</label>
												...
												<div class="row align-items-center">
													...
													<div class="col-md-6">
														<div class="form-group ">
															<label for="fin10" class="form-label text-muted fst-italic">
																fin semana 10
															</label>
															<label for="fin10"
																class="form-label text-muted fst-italic">fin semana
