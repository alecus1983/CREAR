...
$id = $d->id_persona;
$admin = $d->is_admin($usuario);
$ano = date('Y');
//echo var_dump($d);

//echo $d->nombres." admin : ".$admin ;
?>
<!DOCTYPE html>
<html lang="es">
    <head>
	...
	<style>
	 ...
	 #content {
             max-width: 1200px; /* Define un ancho máximo para el contenido */
             margin: 0 auto; /* Centra el div horizontalmente */
             padding: 15px; /* Agrega un poco de relleno para que el contenido no toque los bordes */
	     margin-top: 5% ;
	 }

	 /* Mejora la responsividad de los elementos dentro del div */
	 ...
	 .col {
             flex: 1 1 250px; /* Permite que las columnas se expandan y se reduzcan */
             max-width: 100%;
	 }
	...
	<div id="content" class="container">
	    ...
	    <!-- primera fila -->
	    <div class="row align-items-center  row-board" >
		<div class="col-md-1 col-lg-2"></div>
		<div class="col-md-1 col-lg-2 align-items-center">
		...
		<div class="col-md-1 col-lg-2"></div>
		<div class="col-md-1 col-lg-2 align-items-center">
		    <a href="login_boletines_x.php" class="d-flex justify-content-center">
	...
	<footer class="py-4 bg-light mt-auto">
		...
		<div class="d-flex align-items-center justify-content-between small">
		    <div class="text-muted">Copyright &copy; Mundo Creativo 2025</div>
		    <div>
