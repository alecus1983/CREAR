							...
							success: function(respuesta) {
								...
								if (respuesta['status'] == 1) {
									...
									if (respuesta['status'] == 20) {
										swal('Error', respuesta['html'], 'error');
									}
								}
						...
						<div id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
							...
							<nav class="sb-sidenav-menu-nested nav">
								...
								<input type="number" value="<?php echo date('Y'); ?>" id="years" name="years" min="2015"
									max="2100" step="1" style="background: transparent;color: darkgreen;border: 0px;"
									<?php if ($admin !== 1) { ?> <?php } ?> class="form-control ">
								...
								<select id="periodos" style="background: transparent;color: darkgreen;border: 0px"
									name="periodos" class="form-control" required=""
