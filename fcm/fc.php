	...
	<div id="layoutSidenav_nav">
	  <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
	    ...
	    <select id="periodos" style="background: transparent;color: darkgreen;border: 0px" name="periodos"
			class="form-control" required="" onchange="load_semanas();$('#semana').css('background-color', 'darkkhaki')">
	      <?php
	    ...
	    <select id="escolaridad" style="background: transparent;color: darkgreen;border:  0px"
			class="form-control"
			onchange="lista_grados($('#escolaridad').val(),'#id_g', $('#id_d').val());$('#id_g').css('background-color', 'darkkhaki')">
	    ...
	    <select id="id_g" name="id_gs" class="form-control"  style="background: transparent;color: darkgreen;border:  0px"
	    ...
	    <select id="id_ms" style="background: transparent;color: darkgreen;border: 0px" name="id_ms"
			onchange="load_lista_estudiantes();$('#id_ms').css('background-color', 'transparent');" class="form-control">
	    </select>
