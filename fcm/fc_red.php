			...
			<ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button"
						data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-userfa-fw"></i>
						...
						<div class="nav">
							...
							<div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
								...
								<nav class="sb-sidenav-menu-nested nav">
									...
									<input type="number" value="<?php echo date('Y'); ?>" id="years" class="sel"
										name="years" min="2015" max="2100" step="1" <?php if ($admin == 0) { ?>
											readonly="readonly" <?php } ?> class="form-control ">

									<input type="hidden" value="<?php echo $id; ?>" id="id_d">

									<label for="jornada">Jornada</label>
									<select id="jornada" class="sel form-control" onchange="actualizar();">
										<option value="1">Mañana</option>
										<option value="2">Tarde</option>
									</select>

									<label for="periodos"> Periodo</label>
									<select id="periodos" name="periodos" class="sel form-control" required=""
										onchange="load_();">
									...
									<select id="semana" class="sel form-control" onchange="load_lista_estudiantes();">
										<option value="1">1</option>
									...
									<select id="id_g" name="id_gs" class="sel form-control" onchange="actualizar();">
										<?php
									...
									<select id="id_c" onchange="load_lista_estudiantes();" class="sel form-control">
										<option value="0">A</opcion>
										<option value="1">B</opcion>
									</select>

									<label for="id_ms">Materia</label>
									<select id="id_ms" name="id_ms" onchange="load_lista_estudiantes();"
