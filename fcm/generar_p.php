...
foreach ($list->id_alumno as $e) {
    ...
    foreach ($lista_a as $id_area => $a) {
        ...
        foreach ($lista_m_a as $id_materia => $materia) {
            ...
            // en la tabla
            $p1 = number_format((float) $notax->nota, 1, '.', '');
            ...
            if ($notax->calificado) {
                ...
                $r1 = number_format((float) $notax->nota, 1, '.', '');
                // guardo el valor para calculos estadisticos
            ...
            $p2 = number_format((float) $notax->nota, 1, '.', '');
            ...
            if ($notax->calificado) {
                // almaceno la recuperacion del primer periodo
                $r2 = number_format((float) $notax->nota, 1, '.', '');
                // guardo el valor para calculos estadisticos
            ...
            // en la tabla 
            $p3 = number_format((float) $notax->nota, 1, '.', '');
            ...
            if ($notax->calificado) {
                // almaceno la recuperacion del primer periodo
                $r3 = number_format((float) $notax->nota, 1, '.', '');
                // guardo el valor para calculos estadisticos
            ...
            $p4 = number_format((float) $notax->nota, 1, '.', '');
            ...
            if ($notax->calificado) {
                // almaceno la recuperacion del primer periodo
                $r4 = number_format((float) $notax->nota, 1, '.', '');
                // guardo el valor para calculos estadisticos
